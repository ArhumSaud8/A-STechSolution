...
<footer style="background-color: #2c3e50" class="text-center text-lg-start  text-muted">
  <!-- Section: Social media -->
  <section  style="background-color: #2c3e50" class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    <!-- Left -->
